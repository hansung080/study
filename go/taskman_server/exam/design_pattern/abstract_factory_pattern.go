...
// MacButton is a Button implemention for Mac.
...
// WinFactory is a UIFactory that can create Windows UI elements.
type WinFactory struct{}

func (WinFactory) CreateButton() Button { return WinButton{} }
func (WinFactory) CreateLabel() Label   { return WinLabel{} }

// MacFactory is a UIFactory that can create Mac UI elements.
type MacFactory struct{}

func (MacFactory) CreateButton() Button { return MacButton{} }
func (MacFactory) CreateLabel() Label   { return MacLabel{} }
